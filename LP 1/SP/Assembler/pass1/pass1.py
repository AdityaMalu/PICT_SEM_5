...
class AssemblerPass1:
    ...
    def process(self):
        file = open(
            "/home/pict/31148/Assignment1/pass1/TestCase.asm", "r")
        for lines in file:
            word = lines.replace("\n", "").replace(
                "'", "").replace(",", "").split("\t")
            print(word)
        ...
        ICFile = open(
            "/home/pict/31148/Assignment1/pass1/IC.txt", "w")
        ICFile.write(self.ic)
        ICFile.close()

        SYMTABFile = open(
            "/home/pict/31148/Assignment1/pass1/Symtab.txt", "w")
        ...
        LITTABFile = open(
            "/home/pict/31148/Assignment1/pass1/Littab.txt", "w")
        ...
        POOLTABFile = open(
            "/home/pict/31148/Assignment1/pass1/Pooltab.txt", "w")
